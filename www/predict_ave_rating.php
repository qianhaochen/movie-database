  ...
  <div class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white bg-secondary rounded shadow-sm">
      <div class="lh-1">
        ...
        <small>For each user that hasn't rated certain movie, We predict each it's rating and then calculate a average
          from rating predictions of all the users that hasn't watched the movie. This approach used here is user-based
          collaborative filtering algorithm. We will calculate a correlation map between each users and predict every
          user's rating based on its similarity to those users who has rated the movie. </small>
      </div>
    </div>
